...
import com.example.demo.board.util.FileUtil;
...
public class BoardServiceImpl implements BoardService{
	...
	public int register(BoardDto dto) {
		...
		boardEntity.setImgPath(imgPath);
	...
	public Page<BoardDto> search(String keyword,Pageable pageable) {
		...
		Page<BoardEntity>list = repository.findByboardTitleContaining(keyword,pageable);
		Page<BoardDto>dtoList = list.map(BoardEntity->entityToDto(BoardEntity)); 
